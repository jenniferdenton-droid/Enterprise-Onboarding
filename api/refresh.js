...
Return ONLY a JSON object (no markdown, no explanation, no preamble) keyed by the same account keys as the input. For each account, return up to 6 of the most important and recent messages, newest first. Prioritize blockers > risks > updates:
